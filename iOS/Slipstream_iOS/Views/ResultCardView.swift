        ...
        ResultCardView(
            viewModel:
                ResultCardViewModel(
                    ...
                    fastestLap: "1:20:507",
                    drivers: [
                        .init(driverTicker: Driver.mockHamilton.driverThicker, value: .first),
                        .init(driverTicker: Driver.mockVertasppen.driverThicker, value: .second),
                        .init(driverTicker: Driver.mockLeclerc.driverThicker, value: .third)
                    ]
                )
        )
    }
